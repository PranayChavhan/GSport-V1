...
const Participate = () => {
    ...
    return (
      ...
      <h1 className="text-2xl md:text-2xl font-bold text-blue-gray-700" >Additional Payment Details</h1>
      ...
      <div className="w-full flex flex-row  items-center justify-between lg:justify-between gap-4 ">
        <Button color='orange' onClick={()=> navigate("/p/participation/step1")} >
          Prev
        </Button>
