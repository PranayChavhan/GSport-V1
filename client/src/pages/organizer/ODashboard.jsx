...
const ODashboard = () => {
  ...
  <div className=" ">
    <div className="flex flex-wrap gap-0 -m-4">
      <div className="p-4 md:w-1/3">
        <div className="h-full bg-white shadow-md border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
...
<section className="text-gray-600 body-font bg-white mt-28 shadow-md rounded-lg">
